		...
		<div class="row divCli">
			<div class="col-12">
				<div class="text-center bg-secondary text-white">
					<form action="/Desafio/insereUsuario" method="post">
						<div class="form-group cadCli">
							<div class="row col-12">
								<label class="col-1 pt-2" for="nome">Nome: </label> 
								<input class="form-control col-3 ml-3 mr-3" name="nome" placeholder="Insira seu nome">
								<label class="col-1 pt-2" for="sobrenome">Sobrenome: </label> 
								<input class="form-control col-3 ml-3 mr-3" name="sobrenome" placeholder="Insira seu Sobrenome"> 
								<label class="col-1 pt-2" for="cpf">Cpf: </label> 
								<input class="form-control col-2 ml-3 mr-3" name="cpf" placeholder="Insira seu cpf">
							</div>
							<div id="divTel" class="row col-12 p-0">
								<div class="col-3  p-0 ml-3 d-inline-flex">
									<label class="col-3 p-0 pt-2 ml-1" for="telefone">Telefone: </label> 
									<input class="form-control col-6 ml-2" name="telefone" placeholder="Insira seu telefone">
								</div>
								<div class="col-3 p-0 ml-3 d-inline-flex">
									<label class="col-3 p-0 pt-2 ml-1" for="ddd">DDD: </label> 
									<input class="form-control col-6 ml-2" name="ddd" placeholder="Insira o DDD">
								</div>
							</div>
					  ...
					  <tbody>
						<c:forEach var="user" items="${queryResults}">
							<tr scope="row">
								...
								<th>
									<svg width="1em" height="1em" viewBox="0 0 16 16" class="updateIcon bi bi-pencil" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
			  							<path fill-rule="evenodd" d="M11.293 1.293a1 1 0 0 1 1.414 0l2 2a1 1 0 0 1 0 1.414l-9 9a1 1 0 0 1-.39.242l-3 1a1 1 0 0 1-1.266-1.265l1-3a1 1 0 0 1 .242-.391l9-9zM12 2l2 2-9 9-3 1 1-3 9-9z" />
			  							<path fill-rule="evenodd" d="M12.146 6.354l-2.5-2.5.708-.708 2.5 2.5-.707.708zM3 10v.5a.5.5 0 0 0 .5.5H4v.5a.5.5 0 0 0 .5.5H5v.5a.5.5 0 0 0 .5.5H6v-1.5a.5.5 0 0 0-.5-.5H5v-.5a.5.5 0 0 0-.5-.5H3z" />
									</svg>
								</th>
								<th>
									<svg width="1em" height="1em" viewBox="0 0 16 16" class="deleteIcon bi bi-trash" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
